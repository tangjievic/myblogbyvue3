    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark" style="color:#ffffff;text-align:center">
                    <span class="logo-sm">
                        WetCms
                    </span>
                    <span class="logo-lg">
                ...
                <a href="index.html" class="logo logo-light" style="color:#ffffff;text-align:center">
                    <span class="logo-sm">
                        WetCms
                    </span>
                    <span class="logo-lg">
